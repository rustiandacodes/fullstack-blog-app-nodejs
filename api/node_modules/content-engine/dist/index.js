...
const contentEngine = engineOptions => {
  ...
  if (`runInSubProcess` in engineOptions && engineOptions.runInSubProcess === false) {
    ...
    const contentEngineDir = (0, _createRequireFromPath.resolveFromContentEngine)(`/services/content-engine`, (_engineOptions = engineOptions) === null || _engineOptions === void 0 ? void 0 : _engineOptions.directory);
    if (!contentEngineDir || contentEngineDir && !(0, _fsExtra.existsSync)(contentEngineDir)) {
  ...
  const createSubProcessIfNoneExists = async ({
    ...
    if (!internalState.subProcess) {
      var _engineOptions3, _engineOptions4, _engineOptions5, _stdout, _stderr;
      state.exited = false;
      state.exitCode = undefined;
      internalState.env = env || internalState.env;
      _reporter.default.verbose(`[content-engine] starting subprocess`);
      const contentEngineDir = (0, _createRequireFromPath.resolveFromContentEngine)(`/services/content-engine`, (_engineOptions3 = engineOptions) === null || _engineOptions3 === void 0 ? void 0 : _engineOptions3.directory) || require.resolve(`./services/content-engine`);
      const reduxDir = (0, _createRequireFromPath.resolveFromContentEngine)(`/redux`, (_engineOptions4 = engineOptions) === null || _engineOptions4 === void 0 ? void 0 : _engineOptions4.directory) || require.resolve(`./redux`);
      ...
      internalState.subProcess.start({
        ...
        directory: (_engineOptions5 = engineOptions) === null || _engineOptions5 === void 0 ? void 0 : _engineOptions5.directory
      });
  ...
  const initialize = async ({
    ...
    if (env && internalState.subProcess) {
      console.log(`[content-engine] restarting process since env vars were passed to initialize`);
      await stop();
    }
    if (clearCache) {
      await deleteCache();
    ...
    const {
      ...
      env: env || ((_engineOptions6 = engineOptions) === null || _engineOptions6 === void 0 ? void 0 : _engineOptions6.env)
    });
    if (context) {
  ...
  const sync = async ({
    ...
    if (env && internalState.subProcess && JSON.stringify(env) !== JSON.stringify(internalState.env)) {
      console.log(`[content-engine] restarting process since new env vars were passed to sync`);
    ...
    const {
      ...
      env: env || ((_engineOptions7 = engineOptions) === null || _engineOptions7 === void 0 ? void 0 : _engineOptions7.env)
    });
    if (context) {
      sendFrameworkContext(context);
    }
  ...
  function getStore() {
    ...
    internalState.store ||= (0, _lmdbDatastore.getLmdbStore)({
      dbPath: (0, _lmdbDatastore.getDefaultDbPath)((_engineOptions8 = engineOptions) === null || _engineOptions8 === void 0 ? void 0 : _engineOptions8.directory)
    });
