import { InteractionCallbackFunc } from "./surface/types";
...
export interface UIElementCardOptions extends UIBaseElementDefinition {
    contents: Array<UIElementOptions>;
    title: string;
    description?: string;
}
...
export type UIElementInputSelectOptions = UIBaseElementDefinition & {
    options?: Array<InputSelectElementOption>;
    placeholder?: string;
    helpText?: string;
    required?: boolean;
...
export interface SurfaceDefinition {
    ...
    routes: Record<string, Array<UIElementOptions>>;
}
